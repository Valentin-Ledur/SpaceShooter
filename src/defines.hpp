...
// rotation
const std::string ASTEROID_BASIC_BASE_1_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_base_1.png";
const std::string ASTEROID_BASIC_BASE_2_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_base_2.png";

const std::string ASTEROID_BROWN_BASE_1_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_base_1.png";
const std::string ASTEROID_BROWN_BASE_2_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_base_2.png";

const std::string ASTEROID_ICE_BASE_1_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_base_1.png";
const std::string ASTEROID_ICE_BASE_2_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_base_2.png";

// animation
const int ASTEROID_ANIMATION_SPEED = 150;
const int ASTEROID_BASIC_FRAME = 4;

const std::string ASTEROID_BASIC_1_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_1.png";
const std::string ASTEROID_BASIC_2_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_2.png";
const std::string ASTEROID_BASIC_3_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_3.png";
const std::string ASTEROID_BASIC_4_TEXTURE_PATH = "data/asteroid/basic/asteroid_basic_4.png";

const std::string ASTEROID_BROWN_1_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_1.png";
const std::string ASTEROID_BROWN_2_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_2.png";
const std::string ASTEROID_BROWN_3_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_3.png";
const std::string ASTEROID_BROWN_4_TEXTURE_PATH = "data/asteroid/brown/asteroid_brown_4.png";

const std::string ASTEROID_ICE_1_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_1.png";
const std::string ASTEROID_ICE_2_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_2.png";
const std::string ASTEROID_ICE_3_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_3.png";
const std::string ASTEROID_ICE_4_TEXTURE_PATH = "data/asteroid/ice/asteroid_ice_4.png";
